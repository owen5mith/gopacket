...
func TestPacketIPv6HopByHop0Decode(t *testing.T) {
	ip6 := &IPv6{
		...
		HopLimit:     64,
		SrcIP:        netip.MustParseAddr(net.IP{0x20, 0x01, 0x0d, 0xb8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01}.String()),
		DstIP: netip.MustParseAddr(net.IP{0x20, 0x01, 0x0d, 0xb8, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02}.String()),
	}
